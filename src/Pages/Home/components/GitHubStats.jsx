        ...
        >
          {statCards.map(({ label, value, icon, link }) => (
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="group flex flex-col items-center justify-center bg-white dark:bg-gray-800 rounded-2xl px-8 py-6 shadow-lg hover:shadow-2xl dark:shadow-gray-900/30 transition-all duration-300 border border-gray-100 dark:border-gray-700 relative overflow-hidden w-52"
            >
              {/* Glow effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-indigo-100 via-transparent to-indigo-100 dark:from-indigo-900/20 dark:via-transparent dark:to-indigo-900/20 opacity-0 group-hover:opacity-100 transition duration-500 blur-2xl"></div>
